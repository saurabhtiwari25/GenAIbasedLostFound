...
public class ItemController {
    ...
    public ResponseEntity<Page<ItemResponseDto>> getAllItems(
        ...
        Page<ItemResponseDto> items =
                itemService.getAllItems(PageRequest.of(page, size));
    ...
    public ResponseEntity<Page<ItemResponseDto>> getMyItems(
        ...
        log.info("Fetching items for user id: {}", user.getId());

        Page<ItemResponseDto> items =
                itemService.getItemsByUser(user.getId(), PageRequest.of(page, size));
    ...
    @GetMapping("/search")
    public ResponseEntity<Page<ItemResponseDto>> searchByTitle(
        ...
        Page<ItemResponseDto> result =
                itemService.searchByTitle(keyword, PageRequest.of(page, size));
    ...
    public ResponseEntity<Page<ItemResponseDto>> filterItems(
        ...
        Page<ItemResponseDto> result =
                itemService.filterItems(location, found, PageRequest.of(page, size));
